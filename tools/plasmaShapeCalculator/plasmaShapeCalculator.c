...
int main ()
{
    ...
    printf("\t\t\t\t--- PLASMA SHAPE CALCULATOR ---\n");
    printf("-----------------------------------------------------------------------------------------------------------------\n");
    printf("This is a program that calculates the shape, thickness and magnitude of a glow discharge AC-DBD plasma  .\n");
    printf("Calculated variables:   Debye length lD, Ha, Rm, N\n");

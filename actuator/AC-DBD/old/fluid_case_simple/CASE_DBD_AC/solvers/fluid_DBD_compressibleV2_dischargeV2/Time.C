...
//added by me /////////////////////////////////////////
Foam::word Foam::Time::CustomtimeName(const scalar t, const int precision)
{
    std::ostringstream buf;
    buf.setf(ios_base::fmtflags(format_), ios_base::floatfield);
    buf.precision(precision);
...
//    CustomTime == timeName.value() % period;
//    buf << CustomTime;
    buf << t;
    return buf.str();
}
...
Foam::word Foam::Time::CustomtimeName() const
{
    return dimensionedScalar::Customname();
}
////////////////////////////////////////////////////////

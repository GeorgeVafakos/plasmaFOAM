...
int main(int argc, char *argv[])
{
    ...
    while( runTime.loop() )
    {
        ...
        // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
        // YiFlux = linearInterpolate(mobilityCoeffSpecies[1])*mesh.magSf()*fvc::snGrad(volt);
        ...
        {
            // Y[composition.species().find("e")].boundaryFieldRef()[patchID] == 0.0;
